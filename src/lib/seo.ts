...
export const SITE = {
  ...
  ogImageWidth: 1920,
  ogImageHeight: 1088,
  /** Square logo for Google Knowledge Panel / Organization schema (min 112x112, ideally 512). */
  logo: "https://walandco.ca/logo-square.png",
  logoWidth: 512,
  logoHeight: 512,
  /** SERP favicon — must be square and a multiple of 48px. */
